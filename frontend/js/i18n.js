...
const i18n = {
  zh: {
    ...
    // Remote Auth & IPv6
    remoteAuthTitle: '远程连接安全验证',
    remoteAuthDesc: '检测到您正在通过远程网络 (IPv6 / 公网) 访问，请输入密码以解锁主页。',
    remoteAuthInputPlaceholder: '请输入远程访问密码',
    remoteAuthRemember: '记住此设备 (30天免密)',
    remoteAuthBtnLogin: '验证并进入主页',
    remoteAuthLoggingIn: '正在验证...',
    remoteAuthLogout: '退出远程授权',
    remoteSecurityTitle: '远程 IPv6 访问与安全',
    remoteSecurityDesc: '开启远程密码保护，保障外网与 IPv6 直连安全。',
    enableRemoteAuth: '启用远程连接密码保护',
    lanBypassAuth: '局域网 (Wi-Fi) 内免密码访问',
    lanBypassAuthDesc: '开启后，同一 Wi-Fi 下的手机/平板无需输密码，仅外网/IPv6 连接需要验证',
    remotePasswordLabel: '远程访问密码',
    setRemotePassword: '设置 / 修改远程密码',
    oldPasswordLabel: '原密码',
    newPasswordLabel: '新密码',
    confirmPasswordLabel: '确认新密码',
    saveSecuritySettings: '保存安全设置',
    passwordNotSetTip: '（尚未设置密码，所有远程连接免密）',
    passwordSetTip: '（已设置密码保护）',
  ...
  en: {
    ...
    noBookmarks: 'No bookmarks yet in this book',
    drawerThumbnails: 'Thumbnails Drawer',
    drawerChapters: 'Chapters Drawer',
    drawerBookmarks: 'Bookmarks Drawer',
    closeDrawer: 'Close',

    // Bookshelf Manage Modal
    modalBookshelfTitle: 'Bookshelf Management',
    addFolderTitle: 'Add Local Folder to Bookshelf',
    inputPathPlaceholder: 'Full Path (e.g. D:\\Comics or /Users/name/Pictures)',
    ...
    // LAN Info Modal
    modalLanTitle: 'Multi-Device Access',
    ...
    // Remote Auth & IPv6
    remoteAuthTitle: 'Remote Connection Security',
    remoteAuthDesc: 'A remote connection (IPv6 / Public Network) has been detected. Please enter your password to unlock the library.',
    remoteAuthInputPlaceholder: 'Enter remote access password',
    remoteAuthRemember: 'Remember this device (30 days)',
    remoteAuthBtnLogin: 'Verify & Enter',
    remoteAuthLoggingIn: 'Verifying...',
    remoteAuthLogout: 'Log out Remote Session',
    remoteSecurityTitle: 'Remote IPv6 Access & Security',
    remoteSecurityDesc: 'Set a password to protect your library when accessing remotely over IPv6.',
    enableRemoteAuth: 'Enable Remote Access Password Protection',
    lanBypassAuth: 'Bypass Password on Local Network (Wi-Fi)',
    lanBypassAuthDesc: 'When enabled, devices on the same Wi-Fi do not need a password, only remote/IPv6 connections require it',
    remotePasswordLabel: 'Remote Access Password',
    setRemotePassword: 'Set / Change Password',
    oldPasswordLabel: 'Current Password',
    newPasswordLabel: 'New Password',
    confirmPasswordLabel: 'Confirm New Password',
    saveSecuritySettings: 'Save Security Settings',
    passwordNotSetTip: '(No password configured, remote access unrestricted)',
    passwordSetTip: '(Password protection enabled)',
